...
public class VisualPiece : MonoBehaviour
{
    ...
    {
        // Only allow if this is the local player AND it's their turn
        if (NetworkManager.Singleton.IsClient || NetworkManager.Singleton.IsHost)
        {
            var localPlayer = NetworkManager.Singleton.LocalClient.PlayerObject.GetComponent<NetworkPlayer>();
            return GameManager.Instance.SideToMove == localPlayer.PlayerSide && PieceColor == localPlayer.PlayerSide;
        }
        return false;
    }
    ...
    public void OnMouseDown()
    {
        ...
        {
            Debug.Log("Not your turn or wrong piece.");
            return;
        }
    ...
    public void OnMouseUp()
    {
        ...
        if (enabled)
        {
            ...
            Debug.Log("Piece Moved from visual piece");
        }
    }
}
